...
def main():
    if not SARVAM_API_KEY or SARVAM_API_KEY == "YOUR_SARVAM_API_KEY":
        print("Please set your Sarvam API key in the environment as SARVAM_API_KEY.")
        sys.exit(1)
